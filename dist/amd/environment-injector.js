define(["require", "exports", "@geckoai/class-mirror", "./decorates", "./utils", "./tsyringe", "./tsyringe/dependency-container"], function (require, exports, class_mirror_1, decorates_1, utils_1, tsyringe_1, dependency_container_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.EnvironmentInjector = void 0;
    var EnvironmentInjector = (function () {
        function EnvironmentInjector(target, parent, metadata) {
            ...
            this._origin = target;
            var mirror = class_mirror_1.ClassMirror.reflect(this.target);
            var decorates = mirror.getAllDecorates(decorates_1.ModuleDecorate);
            this.container =
            ...
            this.container.registerInstance(class_mirror_1.ClassMirror, mirror);
            ...
            _providers.forEach(function (it) {
                if ((0, utils_1.isTokenWithProvider)(it)) {
                    if ((0, tsyringe_1.isClassProvider)(it)) {
                        var token_1 = it.token, useClass = it.useClass;
                        var mirror_1 = class_mirror_1.ClassMirror.reflect(useClass);
                        var decorates_2 = mirror_1.getAllDecorates(decorates_1.LifecycleDecorate);
                    ...
                    if ((0, tsyringe_1.isValueProvider)(it)) {
                        container.register(it.token, it);
                        return;
                    }
                    if ((0, tsyringe_1.isFactoryProvider)(it)) {
                        container.register(it.token, it);
                        return;
                    }
                    if ((0, tsyringe_1.isTokenProvider)(it)) {
                        container.register(it.token, it);
                        return;
                    }
                }
                if ((0, utils_1.isConstructorToken)(it)) {
                    var mirror_2 = class_mirror_1.ClassMirror.reflect(it);
                    var decorates_3 = mirror_2.getAllDecorates(decorates_1.LifecycleDecorate);
                    if (decorates_3.length) {
                        decorates_3.forEach(function (d) {
                ...
                if ((0, tsyringe_1.isNormalToken)(it)) {
                    container.register(it, { useValue: it });
                    return;
                }
            });
            _imports.forEach(function (imp) {
                if ((0, utils_1.isModuleWithProviders)(imp)) {
            ...
            if (parent) {
                _exports.forEach(function (it) {
                    if ((0, utils_1.isModuleWithProviders)(it)) {
                    ...
                    if ((0, utils_1.isConstructorToken)(it) || (0, tsyringe_1.isNormalToken)(it)) {
                        parent.acceptChildrenExport(it, _this);
                        return;
                    }
                });
            }
            var lifecycles = mirror.getAllDecorates(decorates_1.LifecycleDecorate);
        ...
        EnvironmentInjector.createRootContainer = function () {
            var root = new dependency_container_1.InternalDependencyContainer();
